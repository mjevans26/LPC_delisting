...
fluidPage(
  ...
  fluidRow(
    column(12,
           p(class = 'caption',
             tags$b("Figure 2."), "Exapmle of well drilling pads constructed after September 1", tags$sup("st"), ", 2015 identified by automated land cover change detection.  Use the slider to reveal new pads detectable only using satellite remote sensing data.")
    )
  )
)
```
...
fluidPage(
  ...
  tags$img(src="ag_conversion.png", class="figure-img img-fluid rounded", alt="Well pad buffer")
      ...
      p(class = 'caption',
        tags$b("Figure 3."), " Conversion of Lesser prairie-chicken habitat to agriculture between 2015 and 2016.")
    )
  )
)
```
...
fluidPage(
  ...
  tags$img(src="oil_buffer.png", class="figure-img img-fluid rounded", alt="Well pad buffer")
      ...
      p(class = 'caption',
        tags$b("Figure 3."), " Buffered areas surrounding oil and gas wells encompassing previously degraded habitat (a) were not included in our calcultion of total acreage.  Only areas containing primarily intact LPC habitat (b) were included.")
    )
  )
)
```
